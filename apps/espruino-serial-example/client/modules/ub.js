exports = function(config) {
    ...
    bus.on('m', function() {
        ...
        try {
            //clearTimeout(timeout); //add this in if you're using Espruino 1v84
        } catch (e) {
            log(e);
        }
    });
    ...
    /* create */
    /*exports.blackbox.create = function(params) {
    ...
    /* read */
    /*exports.blackbox.read = function(params) {
    ...
    /* update */
    /*exports.blackbox.update = function(params) {
    ...
    /* delete */
    /*exports.blackbox.delete = function(params) {
